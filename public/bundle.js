(function () {
    ...
    ***************************************************************************** */
    ...
    var mapObj = function mapObj(object, fn, options, seen) {
    ...
    jquery(".open-mobile-menu").click(function (e) {
        e.preventDefault();
        jquery(".open-mobile-menu").toggleClass("is-active");
        jquery(".mobile-menu").toggleClass("visible invisible");
        jquery(".mobile-menu").toggleClass("opacity-100 opacity-0");
    });
    var swipers = document.querySelectorAll(".swiper-carousel");
    for (var i = 0; i < swipers.length; i++) {
        var id = swipers[i].id;
        var data$1 = camelcaseKeys(jquery(swipers[i]).data());
        new Swiper("#" + id, __assign({}, data$1, { navigation: {
    ...
    jquery(".modal-toggle").on("click", function () {
