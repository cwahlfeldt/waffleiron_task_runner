<header class="main-header bg-yellow py-3 fixed w-full z-50">
  ...
  <div class="container xl:px-0 px-4 h-full">
    <div class="flex flex-row items-center h-full">
      ...
      <a href="/">
        <img class="w-48 sm:w-64" src="/wp-content/themes/waffleiron/src/images/logo-horiz-new.png" alt="Classic Events Catering Horizontal Logo" title="Classic Events Catering Horizontal Logo">
      </a>
      ...
      <button class="open-mobile-menu hamburger hamburger--collapse xl:hidden ml-auto" type="button">
